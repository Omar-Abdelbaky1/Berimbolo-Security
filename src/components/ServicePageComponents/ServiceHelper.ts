...
At Berimbolo Security, we understand that every client has unique security needs, which is why we work closely with our clients to design and implement customized security solutions. Our Protection Officers are an integral part of these solutions, providing a visible security presence and ensuring the safety and security of our clients' people and property.`,
    category: "protection",
...
At Berimbolo Security, we understand that personal protection is a serious matter, and we are committed to providing our clients with the highest level of protection possible. Our team works closely with clients to understand their needs and concerns, and we develop customized protection plans to ensure their safety and security.

We pride ourselves on our attention to detail, professionalism, and dedication to our clients' safety. Whether you require personal protection for yourself, your family, or your business, you can trust Berimbolo Security to provide you with the best protection services available.`,
    category: "protection",
    thumbnail: personal,
    img_urls: [
      "https://plus.unsplash.com/premium_photo-1663047796646-975442b1538b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8c2VjdXJpdHklMjBndWFyZHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60",
...

  {
    ...
    longDescription: `Berimbolo Security's Cash in Transit service provides safe and secure transportation of cash, valuables, and other high-value assets from one location to another. Our team of highly trained security professionals ensure the safety and protection of your assets during transit.
...
Our Cash in Transit service is designed to provide a reliable, secure, and efficient solution for your transportation needs. With Berimbolo Security, you can rest assured that your valuable assets are in safe hands, and we will go above and beyond to ensure they reach their destination safely and securely.`,
    category: "courier",
    thumbnail: cit,
    img_urls: [
...

  {
    ...
    shortDescription:
      "At Berimbolo Security Service we offer a wide range of electronical services such as :- CCTV cameras for any location, access control systems such as key card entry, and various alarm systems.",
    longDescription: `Berimbolo Security provides a comprehensive range of security solutions that can be tailored to meet the specific needs of any business or property. Our CCTV, Access Control and Alarms service is designed to provide clients with peace of mind and ensure that their assets, employees and customers are protected at all times.
...
Overall, Berimbolo Security's CCTV, Access Control and Alarms service is an essential component of any comprehensive security plan, providing businesses and property owners with the tools they need to protect their assets, employees and customers from harm.`,
    category: "monitoring",
    thumbnail: cam,
    img_urls: [
  ...
  },
  {
    ...
    shortDescription:
      "Berimbolo Security Services Limited’s monitoring packages all include professional monitoring 24 hours a day, 7 days a week, and 365 days a year.",
    longDescription: `Alarm Monitoring is an essential service offered by Berimbolo Security, a leading security company. It involves constant and real-time monitoring of alarm systems installed at various locations, including homes, businesses, and government buildings, to ensure that any security breach or emergency is quickly detected and responded to. 

When an alarm is triggered, the monitoring system at Berimbolo Security's central station receives an alert, and trained professionals quickly assess the situation. They use advanced technology to identify the location of the alarm and determine the nature of the emergency, whether it's a fire, a break-in, or a medical emergency. 

Once the nature of the emergency is determined, the monitoring team dispatches the appropriate emergency services, such as the police, fire department, or medical services. In addition, Berimbolo Security can also send its own highly trained response teams to the location to assist in the resolution of the emergency.

With Berimbolo Security's Alarm Monitoring service, you can rest assured that your property and loved ones are always protected. The service is available 24/7, 365 days a year, and is supported by state-of-the-art technology and highly trained professionals who are dedicated to your safety and security.`,
    category: "monitoring",
    thumbnail: alarm,
    img_urls: [
      "https://images.unsplash.com/photo-1549109926-58f039549485?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Nnx8c2VjdXJpdHklMjBjYW1lcmFzfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60",
  ...
  },
  {
    ...
    longDescription: `Berimbolo Security's courier service is a highly reliable and secure way to transport important items and documents from one location to another. Our experienced and well-trained security personnel will handle the delivery of your items with the utmost care and attention to detail.
...
At Berimbolo Security, we understand the importance of confidentiality and security when it comes to courier services. That's why we use state-of-the-art technology and protocols to safeguard your items during transport, including GPS tracking, secure locking mechanisms, and real-time monitoring.
...
Whether you need to transport legal documents, financial records, or high-value items, our courier service provides you with peace of mind knowing that your items are in the hands of trusted and reliable security professionals.`,
  ...
  },
  {
    ...
    longDescription: `Berimbolo Security's investigation services are designed to help individuals, businesses, and organizations uncover vital information and evidence related to a wide range of security concerns. Our team of highly trained and experienced investigators uses the latest technology and techniques to gather and analyze data, conduct interviews, and uncover facts that can be critical to your safety and security.
...
At Berimbolo Security, we understand that every situation is unique, and we pride ourselves on our ability to provide customized investigation services that are tailored to the individual needs of our clients. Whether you require discreet surveillance, in-depth research and analysis, or expert witness testimony, we have the expertise and resources to get the job done. Contact us today to learn more about how our investigation services can help you achieve your security goals.`,
    category: "other",
  ...
  },
  {
    ...
    longDescription: `Special Event Security is a service offered by Berimbolo Security, a professional security company. Our expert security personnel are specially trained to provide top-notch security coverage for events of all types and sizes. We understand that events can present unique security challenges, and that's why we customize our security plans to meet the specific needs of each event we cover.
...
At Berimbolo Security, we understand that every event is different, and that's why we offer customizable security solutions that meet the unique needs of each event. Whether you're planning a large-scale music festival or a small corporate gathering, our experienced security team will provide the protection you need to ensure a safe and secure event. We take pride in our commitment to excellence, and we're dedicated to providing the highest level of security services to all of our clients.`,
  ...
  },
  {
    ...
    longDescription: `GPS services are an essential component of modern security solutions. At Berimbolo Security, we understand the importance of having real-time information about the location of your valuable assets, vehicles, or personnel. Our GPS services provide you with an accurate and reliable way to track your assets and ensure their safety and security.
...
At Berimbolo Security, we prioritize the security and privacy of your data. Our GPS systems are designed to comply with industry standards, and we employ robust security protocols to protect your data from unauthorized access. With our GPS services, you can rest assured that your assets are in safe hands.`,
    category: "monitoring",
    thumbnail: gps,
    img_urls: [
